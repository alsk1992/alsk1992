...
| launch-factory *(private)* | Fully autonomous AI agent — generates token concepts, creates metadata, deploys to Solana, manages social accounts during launch, handles liquidity. End-to-end, no human input | Python, Solana |
